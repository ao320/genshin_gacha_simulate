function getValues() {
    ...
    const result = `${numSimulations}回のシミュレーションで，引き始めが${startPityCounter}連目の時，ガチャを${numPulls}回引いた時，限定星5キャラは平均${averageDesiredStar5Count.toFixed(2)}体出ます．
                    ${numSimulations}回のシミュレーションで，引き始めが${startPityCounter}連目の時，ガチャを${numPulls}回引いた時，星5キャラは平均${averageTotalStar5Count.toFixed(2)}体出ます．
                    `;
